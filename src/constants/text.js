import { disFood, disMassage, disYoga } from "../images/";
...
export const offerDetails = [
  {
    ...
    subtitle1: 'Relax and Unwind at Chandra',
    subtitleList: [
  ...
  },
  {
    ...
    subtitle1: 'Escape for longer and re-energise',
    subtitleList: [
  ...
  },
  {
    ...
    subtitle1: 'Suites & Private Villa Escape',
    subtitleList: [
    ...
    detailList: [
      ...
      'Enjoy peace of mind when staying with Centara Hotels & Resorts as we continue to follow strict safety protocols and adhere to certified health and hygiene procedures with the comprehensive Chandra Complete Care program.',
    ],
  },{
    image1: disFood,
    image2: disFood,
    ...
    subtitle1: 'Enables guests to experience everything',
    subtitleList: [
    ...
    detailList: [
      'Chandra Unlimited enables guests to experience everything there is at chandra.',
