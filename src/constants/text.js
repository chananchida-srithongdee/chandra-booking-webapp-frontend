...
export const offers = [
   {
      ...
      offerList: ['Fresh daily breakfast', '60-min massage for two', 'Healthy sleep kit', 'In-room workout'],
   ...
   },
   {
      ...
      offerList: ['Minimum stays from 5 nights starting at just THB 1,890++/nigth', 'Choice of room only or room & breakfast rates', 'Free stay for up to 2 children'],
   ...
   },
   {
      ...
      offerList: ['Room rates from THB 19,900++/Night', 'Daily breakfast & dinner throughout stay', 'Free stay for up to 2 children'],
