    ...
    return (
        <div className="w-full">
            <div className="bg-primary h-[800px] relative">
                <img src={bgDiscover} alt="chandra resort" className="w-full h-[800px] object-cover" />
            ...
            <div className="flex flex-col space-y-11 > * + * my-20">
                <div className={`${styles.subHeading}container mx-auto px-40`}>
                    <div className={`${styles.flexCenter}`} >Explore A World Of Tastes</div>
                ...
                <div className={`${styles.subHeading}container mx-auto px-40`}>
                    ...
                    <div className = "flex flex-row space-x-11 > * + * my-20">
                        <div  className={`${styles.photos} flex flex-col justify-center`}>  
                            <img src={disMassage} alt = "disMassage" className='round md:rounded-lg'/>
                        </div>
                        <div>
                            <h2 className="text-justify text-2xl mt-5 container mx-auto px-5" > Discover Healing Traditions </h2>
                            <h3 className="text-justify text-lg mt-5 container mx-auto px-5">Rooted in Thai culture, SPA Cenvaree is a leading global spa operator in Southeast Asia and the Middle East. Varee means water in Sanskrit, signifying our focus on gentle strength and gradual change in holistic healing. Through deeply rejuvenating rituals in soothing surrounds, we will help you revitalise your body and mind.</h3>
                            <h3 className="text-justify text-lg mt-5 container mx-auto px-5">Combining value with signature spa treatments, Cense by SPA Cenvaree offers relaxing spa experiences in select locations. While we specialise in traditional Thai therapies, our indulgent spa menu also includes Ayurvedic rituals, aromatherapy massage and body scrubs that will help you glow from within. Come as you are and restore your vitality under our care.</h3>
                        </div>
                    </div>
                </div>
                <div className={`${styles.subHeading}container mx-auto px-40`}>
                    ...
                    <div className = "flex flex-row space-x-11 > * + * my-20">
                        <div  className={`${styles.photos} flex flex-col justify-center`}>  
                            <img src={disYoga} alt = "disYoga" className='round md:rounded-lg'/>
                        </div>
                        <div>
